...
#choice = options = st.multiselect(
#    'Choose from the top 7 data jobs for visualisation',
...
st.title("Choose job visualisation")
line = st.selectbox("Choose a job title:", df_filterjob.index)
fig = px.box(df[df['job_title']==line], x="experience_level", y="salary_in_euro", color="experience_level"
                ,
                labels={
                         "salary_in_euro": "Salaris in Euro",
                         "experience_level": "Werkervaring"
